<?php
/*
 * This file is a copy of /admin/themes/default/items/edit.php with some
 * changes surrounded by "CHANGES START" and "CHANGES END" comments.
 */
?>
<?php
...
// CHANGES START
include ADMIN_THEME_DIR . '/default/items/form-tabs.php';
// CHANGES END
echo flash();
?>
